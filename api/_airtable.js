...
export const TABLES = {
  ...
  PREFLIGHT:          'tbl3XS1n9edeDuLOn',
  PROJECTS:           'tblHYYTZxN8IHRNwA',
  AIRCRAFT_SENSOR:    'tblbbnIwzQJRa4mpo',
  DAILY_ASSIGNMENTS:  'tblaNln93bTaldquV',
}
...
export const FIELDS = {
  ...
  PILOT_DISPLAY_NAME:   'fldKEKxHbI9lRCXTR',
  ...
  PREFLIGHT_DATE:       'fld3e4DOx5yYCgbYe',
  PREFLIGHT_PILOT:      'fldiapaRvwWUjBC4x',
  PREFLIGHT_PROJECT:    'fldH8N230tZWXxxZr',
  PREFLIGHT_TRAVEL_DAY: 'fldkUrdlnzkuw8ML5',
  PREFLIGHT_TRAVELING_TO: 'fldQEK9X7oGDodpGv',
  PREFLIGHT_VISUAL_OBS: 'fldq9cdjr2Xka4gNU',
  PREFLIGHT_AIRCRAFT:   'fldXJPP7MDKEaLSCV',
  PREFLIGHT_ACRES:      'flde2vhvTKKRjxAf2',
  PREFLIGHT_BASIN:      'fldavOCL4taDWbKjr',
  PREFLIGHT_FLIGHT_ADDR: 'fldWaWcaL4NOJcdnP',
  PREFLIGHT_HOSPITAL:   'fldW4Ofn8HB5QDwon',
  PREFLIGHT_IMSAFE:     'fldkfoTxuuvdDcfBB',
  PREFLIGHT_WEATHER_CHK: 'fldtG4CncB7BPB0Kc',
  PREFLIGHT_WEATHER_FCST: 'flda4qHgaJR1Zu7A3',
  PREFLIGHT_AIRWORTHY:  'fld40658xFfOJ8CFn',
  PREFLIGHT_AIRWORTHY_N: 'fldM9piS7h91ZgBtP',
  PREFLIGHT_AIRSPACE:   'fldjlqeEuvawTW4Y3',
  PREFLIGHT_TFR:        'fldVH0r0hjgPIJneE',
  PREFLIGHT_LAANC_REQ:  'fldlMlZKaYnNcUR1J',
  PREFLIGHT_CREW_REST:  'fldn4FW0OroiL214h',
  PREFLIGHT_CREW_DAYS:  'fld6zYpJ9uxACJxvq',
  PREFLIGHT_CREW_WORK:  'fld7KAF09V0j2lbb7',
  PREFLIGHT_WX_WIND:    'fldlMLvrVa6QbAWoP',
  PREFLIGHT_WX_VIS:     'fldI8QV1OIpbzAukx',
  PREFLIGHT_WX_CEIL:    'fldmFj1nQ0e7DXVUT',
  PREFLIGHT_WX_RAIN:    'fldjlZXJQpCCKub7n',
  PREFLIGHT_WX_TEMP:    'fldT2VZ7fECRALv19',
  PREFLIGHT_WX_TSTORM:  'fldDZPynJrcqmsoMB',
  PREFLIGHT_RISK_TOTAL: 'fldlIeYxPDF6fkOqv',
  PREFLIGHT_ADD_RISKS:  'fld69iUTWmrmVfLxw',
  PREFLIGHT_MITIGATING: 'fldHYjSRFoMTVH24A',
  PREFLIGHT_MISSION_OVW: 'fld2u2SXsljOi1L8l',
  PREFLIGHT_GO_NOGO:    'fldlVErGgP1IJAoLp',
  PREFLIGHT_NOTES:      'fldY4gVkWEfEhZgFV',
  PREFLIGHT_EMERG_CONTACT: 'fldpvClkZS1S30rZ7',
  PREFLIGHT_START_LAT:  'fldAUf6IwteFufphx',
  PREFLIGHT_START_LNG:  'fldF7blLSgdAq9mNz',
  PREFLIGHT_EOD_LINK:   'fldMTHfIuLaJoKdtv',

  // Projects
  PROJECT_NAME:         'fldxRxPZss5l3BFFx',
  PROJECT_ACTIVE:       'fldbGd0Ph45S89qoa',

  // Aircraft/Sensor
  AIRCRAFT_NAME:        'flds8icEjiTRwwWno',

  // Daily Assignments
  DA_PILOT:             'fld5VShFudYtTQ9pm',
  DA_DATE:              'fldP9zDqFfLSt1qqw',
  DA_ROUTE:             'fldeg8UtYSPRn4IaN',
  DA_STATUS:            'fldgp2sUUDa9SoMbz',
}
