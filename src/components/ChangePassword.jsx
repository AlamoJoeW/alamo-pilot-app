  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        {success ? (
          <>
            <p style={{ color: '#22c55e', textAlign: 'center', marginBottom: 20 }}>Password updated successfully</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button type="submit" className="btn-primary" disabled={submitting} style={{ flex: 1 }}>{submitting ? 'Saving...' : 'Save Password'}</button>
            </div>
          </form>
        )}
      </div>
